...
![UML类图之接口描述](/img/UML/10/interface.png)
...
![UML类图之实类描述](/img/UML/10/class.png)
...
![UML类图之依赖关系描述](/img/UML/10/dependency.png)
...
![UML类图之泛化关系描述](/img/UML/10/generalization.jpg)
...
![UML类图之关联关系描述](/img/UML/10/composition.png)
...
![UML类图之聚合关系描述](/img/UML/10/association.png)
...
![UML类图之组合关系描述](/img/UML/10/aggregation.png)
...
![UML类图之实现关系描述](/img/UML/10/realization.png)

## 组合成一个整体

![UML类图之实现关系描述](/img/UML/10/all.png)
