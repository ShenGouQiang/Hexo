...
![填写公私钥的位置信息](http://static.shengouqiang.cn/blog/img/gitOneMoreAccount/saveTheGitHubKey.jpg)
...
![填写公私钥的位置信息](http://static.shengouqiang.cn/blog/img/gitOneMoreAccount/saveTheGiteeKey.jpg)
...
![填写公私钥的位置信息](http://static.shengouqiang.cn/blog/img/gitOneMoreAccount/findTheSettings.jpg)

4. 在这里，我们首先找到在第二步生成的`id_rsa_gitee.pub`文件，将文件的内容复制到下面中：

![填写公私钥的位置信息](http://static.shengouqiang.cn/blog/img/gitOneMoreAccount/addTheSshKey.jpg)
...
![填写公私钥的位置信息](http://static.shengouqiang.cn/blog/img/gitOneMoreAccount/showSuccessResult.jpg)

&emsp;&emsp;那么此时恭喜你，你已经配置成功了。如果出现了

![填写公私钥的位置信息](http://static.shengouqiang.cn/blog/img/gitOneMoreAccount/showErrorResult.jpg)
