...
![查询test表](/img/SQL/isolation/day01/querytest01.jpg)
...
![test表执行insert语句](/img/SQL/isolation/day01/testinsert01.jpg)
...
![test表执行select语句](/img/SQL/isolation/day01/querytest02.jpg)
...
![test表执行select语句](/img/SQL/isolation/day01/querytest05.jpg)

&emsp;&emsp;此时在`session1`中插入一条记录：

![test表执行insert语句](/img/SQL/isolation/day01/testinsert02.jpg)

&emsp;&emsp;此时`session2`再次查询的结果为：

![test表执行select语句](/img/SQL/isolation/day01/querytest06.jpg)
...
![test表执行select语句](/img/SQL/isolation/day01/querytest03.jpg)
...
![test表执行select语句](/img/SQL/isolation/day01/querytest04.jpg)
...
![test表执行select语句](/img/SQL/isolation/day01/querytest07.jpg)

&emsp;&emsp;此时在`session1`中更新记录,并提交：

![test表执行update语句](/img/SQL/isolation/day01/testupdate01.jpg)

&emsp;&emsp;此时`session2`再次查询的结果为：

![test表执行select语句](/img/SQL/isolation/day01/querytest08.jpg)
...
![test表执行select语句](/img/SQL/isolation/day01/querytest09.jpg)
...
![test表执行insert语句](/img/SQL/isolation/day01/testinsert03.jpg)

&emsp;&emsp;此时我们再次在`session2`中进行查询

![test表执行select语句](/img/SQL/isolation/day01/querytest10.jpg)
...
![test表执行select语句](/img/SQL/isolation/day01/querytest11.jpg)
...
![test表执行insert语句](/img/SQL/isolation/day01/testinsert04.jpg)
...
![隔离级别总结图](/img/SQL/isolation/day01/isolation.jpg)